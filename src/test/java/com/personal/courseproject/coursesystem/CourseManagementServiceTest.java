...
class CourseManagementServiceTest {
    ...
    void should_get_courses_by_id() {
        ...
        Optional<Course> courses = courseManagementService.getCoursesById(1);

        Assertions.assertEquals(ofNullable(course1),courses);
    ...
    void should_add_course() {
        ...
        Course course = courseManagementService.addCourses(course1);
    ...
    @Test
    void should_not_update_course_by_invalid_id_and_also_if_the_title_is_null() {
        ...
        Assertions.assertEquals(null,updateCourseResult);
    }
    ...
    void should_delete_course_by_id() {
        ...
        Assertions.assertEquals(true,deleteCourseResult);
    }
    ...
    void should_not_delete_course_by_invalid_id() {
        ...
        Assertions.assertEquals(false,deleteCourseResult);
    }
}
